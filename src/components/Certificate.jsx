...
function Certificate({certData}){
  return (
    <>
    <div id="certcon" className="w-800 h-600 mt-4 mb-20 mx-auto bg-white border border-black text-center p-30 box-border">
      ...
      <p className="ml-24 mb-4">Company : {certData.companyName}</p>
      </div>
     </div>
      </>
  );

         ...
         <Navbar />
            <div className="p-6 container md:w-2/3 xl:w-auto mx-auto  flex flex-col xl:items-stretch justify-between xl:flex-row">
                ...
                <div className="w-full xl:w-1/2 xl:pl-40 xl:py-28 ">
                    <h1 className="text-2xl md:text-4xl xl:text-5xl font-bold leading-10 text-gray-800 mb-4 text-center xl:text-left md:mt-0 mt-4">Newslater</h1>
                    <p className="text-base leading-normal text-gray-600 text-center xl:text-left">Subscribe us to receive any future updates on our sites. ( No spam mails ... we assure you! )</p>
                    <div className="flex items-stretch mt-12">
                        ...
                        <button onClick={handleClick} className="w-32 rounded-l-none hover:bg-indigo-600 bg-indigo-700 rounded text-base font-medium leading-none text-white p-5 uppercase focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700">subscribe</button>
                    </div>
                </div>
            </div>
            <Footer />
